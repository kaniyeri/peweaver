# PEWeaver ungated dual-core FFT reference constraints (identical frozen constraint set) — frozen per physical/README.md.
...
set_input_delay 1.5000 -clock core_clock [get_ports {di_en di_re di_im mode}]
set_output_delay 1.5000 -clock core_clock [get_ports {do_en do_re do_im}]

# External reset asynchronously asserts the reset synchronizer.  Waive that
# boundary only; the synchronously generated release remains timed.
set_false_path -from [get_ports reset]

# Explicit I/O environment: driven inputs, loaded outputs.
set_driving_cell -lib_cell sky130_fd_sc_hd__buf_4 [get_ports {di_en di_re di_im mode reset}]
